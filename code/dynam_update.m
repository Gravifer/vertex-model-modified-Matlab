...
%参考文献：[Liu,Z.Y.2020]Mesoscopic dynamic model of epithelial cell division with cell-cell junction effects https://doi.org/10.1103/PhysRevE.102.012405
...
%参考文献：[Liu,Z.Y.2020]https://doi.org/10.1103/PhysRevE.102.012405
F_c = zeros(Nv,2);
for i = 1:Nc
    vList = cell_v{i};
    for j = 1:length(vList)
